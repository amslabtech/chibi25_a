...
def generate_launch_description():
    ...
    custom_package_node = Node(
        package='team_a_global_path_planner', # Replace with your actual package name
        executable='team_a_global_path_planner_node',  # Replace with your actual executable name
        name='custom_node',
        output='screen',
